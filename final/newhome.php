          ...
          <div class="row ">
                  <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="sidenav">
                          <div class="card-body">
                              <button type="button" class="btn btn-outline-info">Woodworker</button>
                              <button type="button" class="btn btn-outline-warning">Cement-mistiri</button>
                              <button type="button" class="btn btn-outline-success">Labour/helper</button>
                              <button type="button" class="btn btn-outline-dark">Electrician</button>
                              <button type="button" class="btn btn-outline-primary">Plumber</button>
                 ...
                 <div class="col-md-6 gedf-main" style="position: relative;">
                    ...
                    <form enctype="multipart/form-data" action="<?php echo($_SERVER["PHP_SELF"]); ?>"    method="POST">
                        <div class="card gedf-card">
                            ...
                            <div class="card-body" style='border-top-left-radius: 8px; border-top-right-radius: 8px; background-color: #35414F;'>
